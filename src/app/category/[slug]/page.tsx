      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="relative w-16 h-16 mx-auto mb-6">
            ...
            <div className="absolute inset-0 border-4 border-t-accent-green border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin"></div>
          </div>
          <h2 className="text-xl font-bold text-gray-800 mb-2">
            Loading Category...
          </h2>
          <p className="text-accent-green">Please wait</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button
            ...
            className="px-6 py-3 bg-accent-green text-white rounded-lg font-semibold hover:bg-accent-green/80 transition-colors duration-300"
          >
            Try Again
          </button>
        </div>
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="px-2 py-1 bg-accent-green text-white text-xs font-medium rounded-md">
                  ...
                  <div className="p-5">
                    ...
                    <Link href={`/news/${encodeURIComponent(article.slug)}`}>
                      <h3 className="text-lg font-bold text-gray-900 mb-2 hover:text-accent-green transition-colors duration-200 line-clamp-2 leading-tight">
                        {article.news_Title}
                      </h3>
                    </Link>
