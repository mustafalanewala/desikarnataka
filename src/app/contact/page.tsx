...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "ಧನ್ಯವಾದಗಳು! ನಿಮ್ಮ ಸಂದೇಶವನ್ನು ಸ್ವೀಕರಿಸಲಾಗಿದೆ. ನಾವು ಶೀಘ್ರದಲ್ಲೇ ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸುತ್ತೇವೆ."
    );
      ...
      <div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm py-4">
            ...
            <span className="text-gray-900 font-semibold">ಸಂಪರ್ಕ</span>
          </nav>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <p className="text-gray-600 mb-8">
              ನಿಮ್ಮ ಪ್ರಶ್ನೆಗಳು, ಸಲಹೆಗಳು ಅಥವಾ ಪ್ರತಿಕ್ರಿಯೆಗಳನ್ನು ನಮಗೆ ಕಳುಹಿಸಿ.
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-green focus:border-accent-green transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-green focus:border-accent-green transition-colors"
                  placeholder="ಸಂದೇಶದ ವಿಷಯವನ್ನು ನಮೂದಿಸಿ"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-green focus:border-accent-green transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-accent-green text-white py-3 px-6 rounded-lg font-semibold hover:bg-accent-green/80 transition-colors duration-300 focus:ring-2 focus:ring-accent-green focus:ring-offset-2"
              >
                ಸಂದೇಶ ಕಳುಹಿಸಿ
              </button>
            </form>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">ವಿಳಾಸ</h4>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
              ...
              <p className="text-gray-600 mb-6">
                ಸಾಮಾಜಿಕ ಮಾಧ್ಯಮದಲ್ಲಿ ನಮ್ಮನ್ನು ಅನುಸರಿಸಿ ಮತ್ತು ಇತ್ತೀಚಿನ ಸುದ್ದಿಗಳಿಗೆ
                ನವೀಕೃತವಾಗಿರಿ.
              </p>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center text-white hover:bg-green-700 transition-colors duration-300"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
